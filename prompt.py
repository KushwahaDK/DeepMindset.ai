def build_mcq_question_generation_prompt(difficulty, topics):
    """
    Builds an f-string prompt for GPT-4 (or other LLMs) to generate MCQ-style questions.
    
    :param difficulty: str, one of ["easy", "medium", "hard", "expert"]
    :param topics: list of str, the high-level topics
    :return: str, the final prompt
    """
    return f"""
